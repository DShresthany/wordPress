...
public class ProfileStepDefs {
  ...
  public void i_land_on_wordpress_my_user_profile_page() {
    ...
    Assert.assertTrue(actions.verifyProfile());

  }

  @Given("I enter my first name {string}, lastname {string}, public display name {string} and about me description {string}")
  public void i_enter_my_first_name_lastname_public_display_name_and_about_me_description(
      String firstName, String lastName, String publicName, String description) {
...
//	wait.until(ExpectedConditions.elementToBeClickable(element))
  ...
  public void i_can_see_Settings_saved_successfully_notification() {
    Assert.assertEquals(true, actions.verifySaveAction());
  }
